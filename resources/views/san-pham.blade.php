...
<head>
    ...
    <meta name="description" content="Sản phẩm chè đen và chè xanh chất lượng cao từ Tân Bình Tea - Xuất khẩu quốc tế.">
    <title>Sản phẩm - Tân Bình Tea</title>
...
<body>
    ...
    <section class="page-banner" id="page-banner">
        ...
        <div class="page-banner-content">
            <h1 class="page-banner-title">SẢN PHẨM</h1>
            ...
            <div class="products-grid" id="black-tea-grid">
                <div class="product-card" id="product-pekoe">
                    ...
                    <div class="product-actions">
                        <a href="/san-pham-chi-tiet" class="product-arrow">
    ...
    <section class="products products-green" id="san-pham-xanh">
       ...
       <div class="product-card" id="product-madina">
                ...
                <div class="product-card">
                    <p class="product-name">Vietnam Green Tea: Demo 1</p>
                    <div class="product-image">
                        <img src="assets/images/products/product-tea-generic.png" alt="Vietnam Green Tea: Demo 1">
                    </div>
                    <div class="product-actions">
                        <a href="/san-pham-chi-tiet" class="product-arrow">
                            <svg width="40" height="12" viewBox="0 0 40 12" fill="none" xmlns="http://www.w3.org/2000/svg">
