...
@section('content')
    ...
    <section class="about-split" id="about-split">
        <div class="about-split-left" data-aos="fade-right">
        ...
        <div class="about-split-right" data-aos="fade-left">
    ...
    <!-- About Bar -->
    <div class="about-bar">
        <div class="about-bar-content" data-aos="zoom-in-up">
    ...
    <section class="about-image-section" id="about-image-section">
        <div class="about-image-section-left" data-aos="fade-right">
        ...
        <div class="about-image-section-right" data-aos="fade-left">
    ...
    <div class="about-aerial" id="about-aerial">
        ...
        <div class="about-aerial-inner">
            ...
            <div class="about-aerial-left" data-aos="fade-up">
                ...
                <div class="about-aerial-image">
                    @if(isset($settings['core_values']) && is_array($settings['core_values']) && count($settings['core_values']) > 0)
                        @foreach($settings['core_values'] as $value)
                            <div class="about-aerial-item" data-aos="fade-up" data-aos-delay="{{ $loop->index * 150 }}">
                        ...
                        @endforeach
                    @else
                        <div class="about-aerial-item" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <div class="about-aerial-item" data-aos="fade-up" data-aos-delay="150">
                        ...
                        <div class="about-aerial-item" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="about-aerial-left about-aerial-van-hoa-left" data-aos="fade-right">
                <h2 class="about-aerial-title">{{ app()->getLocale() == 'vi' ? 'Văn hoá công ty' : 'Company Culture' }}</h2>
            </div>
            <div class="about-aerial-right about-aerial-van-hoa-right" data-aos="fade-left">
