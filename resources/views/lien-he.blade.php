...
@section('title', app()->getLocale() == 'vi' ? 'Liên hệ - Tân Bình Tea' : 'Contact - Tan Binh Tea')
...
@section('content')
    ...
    <section class="page-banner" id="page-banner">
        <div class="page-banner-bg">
            <img src="{{ asset('assets/images/home/hero-tea-banner.png') }}" alt="Búp chè xanh">
        </div>
        <div class="page-banner-content">
            <h1 class="page-banner-title">{{ app()->getLocale() == 'vi' ? 'LIÊN HỆ' : 'CONTACT' }}</h1>
            <img src="{{ asset('assets/images/common/deco-vector-divider.png') }}" alt="" class="page-banner-vector">
            <p class="page-banner-desc">
                {{ $settings['about_short'][app()->getLocale()] ?? 'Vui lòng liên hệ với chúng tôi để được tư vấn và đặt hàng.' }}
            </p>
        </div>
    </section>
            ...
            <div class="contact-info">
                ...
                <ul class="contact-details">
                    <li>
                        ...
                        <span>{{ $settings['contact_address'][app()->getLocale()] ?? 'Xóm Tân Bình, Xã Võ Miếu, Huyện Thanh Sơn, Tỉnh Phú Thọ' }}</span>
                    </li>
                    <li>
                        <span class="contact-icon">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
                        </span>
                        <span><a href="https://tanbinhteacoltd.com/" target="_blank">{{ $settings['contact_website'][app()->getLocale()] ?? 'tanbinhteacoltd.com' }}</a></span>
                    </li>
                    <li>
                        <span class="contact-icon">
                        ...
                        <span><a href="mailto:{{ $settings['contact_email'][app()->getLocale()] ?? 'tanbinhteacompany@gmail.com' }}">{{ $settings['contact_email'][app()->getLocale()] ?? 'tanbinhteacompany@gmail.com' }}</a></span>
                    </li>
                    <li>
                        <span class="contact-icon">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                        </span>
                        <span><a href="tel:{{ $settings['contact_phone'][app()->getLocale()] ?? '+84986843666' }}">{{ $settings['contact_phone'][app()->getLocale()] ?? '(+84) 986 843 666' }}</a></span>
                    </li>
                </ul>
            </div>
            <div class="contact-form-wrapper">
                <form class="contact-form" id="contact-form">
                    <input type="text" placeholder="{{ app()->getLocale() == 'vi' ? 'Họ tên' : 'Name' }}" id="input-name" required>
                    <input type="email" placeholder="Email" id="input-email" required>
                    <input type="tel" placeholder="{{ app()->getLocale() == 'vi' ? 'Số điện thoại' : 'Phone' }}" id="input-phone">
