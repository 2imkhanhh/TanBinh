...
<head>
    ...
    <meta name="description" content="Blog và tin tức mới nhất từ Tân Bình Tea - Kiến thức về trà Việt Nam.">
    <title>Blog - Tân Bình Tea</title>
...
<body>
        ...
        <section class="blog-gallery-section">
            ...
            <div class="blog-gallery-grid">
                <div class="blog-gallery-item">
                    <img src="assets/images/blog/gallery/gallery-01.png" alt="Trà Tân Bình">
                </div>
                <div class="blog-gallery-item">
                    <img src="assets/images/blog/gallery/gallery-01.png" alt="Trà Tân Bình">
                </div>
    ...
    <div class="blog-lightbox" id="blog-lightbox">
        ...
        <div class="blog-lightbox-content">
            ...
            <button class="blog-lightbox-close" id="blog-lightbox-close" aria-label="Đóng">
                ×
            </button>
